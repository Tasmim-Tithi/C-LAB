...
int main()
{
    ...
    {
        CseSocietyMember("Farah",11608001),
        CseSocietyMember("Ashik",11608002),
        CseSocietyMember("Tanvir",11608003),
        CseSocietyMember("Shafi",11608004),
        CseSocietyMember("Shorif",11608005),
        CseSocietyMember("Rakib",11608006),
        CseSocietyMember("Robin",11608008),
        CseSocietyMember("Raihan",11608011),
        CseSocietyMember("Sabbir",11608014),
        CseSocietyMember("Rimi",11608015)
    };
